[tml-server-v1-plugin-3f10-ml] Details
============================
...
STEP 3: `Produce to Kafka Topics <https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-server-v1-plugin-3f10/tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-tml-server-v1-plugin-3f10.py>`_
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
