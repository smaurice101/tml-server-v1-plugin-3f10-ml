[tml-server-v1-plugin-3f10-ml] Operating Details
====================================

Generated On: 2026-03-02 03:17:00 UTC
...
.. important::
   ...
   **not be valid if your [tml-server-v1-plugin-3f10-ml] container is NOT running**.

.. tip::
   You must have your [tml-server-v1-plugin-3f10-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:49689/iot-failure-machinelearning.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   maadsdocker/tml-server-v1-plugin-3f10-ml-amd64 (https://hub.docker.com/r/maadsdocker/tml-server-v1-plugin-3f10-ml-amd64)
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-server-v1-plugin-3f10-ml \
          --env SOLUTIONDAG=solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10 \
          ...
          maadsdocker/tml-server-v1-plugin-3f10-ml-amd64
...
[tml-server-v1-plugin-3f10-ml] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-server-v1-plugin-3f10
...
.. important::
   https://tml-server-v1-plugin-3f10-ml.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46209, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37297, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37177, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=32829, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36371, HPDEHOST=127.0.1.1, HPDEPORT=40367, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42621

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2893-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-preprocess-100-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-ml-4964-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-predict-140-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
