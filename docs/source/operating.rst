...
.. important::
   http://localhost:49689/dashboard-ml.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41265, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38179, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40335, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45253, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37613, HPDEHOST=127.0.1.1, HPDEPORT=46739, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37727

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8673-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-preprocess-149-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-ml-2160-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, python-predict-95-tml-server-v1-plugin-3f10-ml,solution_preprocessing_ml_dag-tml-server-v1-plugin-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
